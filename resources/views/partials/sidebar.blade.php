 <div class="page-sidebar custom-scrollbar">
   ...
   <ul class="sidebar-menu">
     ...
     <li>
       ...
       <ul class="sidebar-submenu">
         <li>
           <a href="#"><i class="fa fa-angle-right"></i>Bootstrap Tables<i class="fa fa-angle-down pull-right"></i></a>
           <ul class="sidebar-submenu">
         ...
         <li>
           <a href="#"><i class="fa fa-angle-right"></i>Data Tables<i class="fa fa-angle-down pull-right"></i></a>
           <ul class="sidebar-submenu">
         ...
         <li>
           <a href="#"><i class="fa fa-angle-right"></i>Extension Data Tables<i class="fa fa-angle-down pull-right"></i></a>
           <ul class="sidebar-submenu">
     ...
     <li>
       ...
       <ul class="sidebar-submenu">
         ...
         <li><a href="chart-radial.html"><i class="fa fa-angle-right"></i>Radial Chart</a></li>
     ...
     <li>
       ...
       <ul class="sidebar-submenu">
         <li><a href="gmap.html"><i class="fa fa-angle-right"></i>Google Maps</a></li>
